...
// Same implementation as WikiMergeV1, except that `extractMergeBuf_ordinal_l_min_unsorted` is used
// to extract both merge and movement-imitation buffer at once.
