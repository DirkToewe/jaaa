...
public interface RecMergePartV1Accessor<T> extends CompareRandomAccessor<T>, BinarySearchAccessor<T>
{
  ...
  default void recMergePartV1_L2R(
    T a, int a0, int aLen,
    T b, int b0, int bLen,
    T c, int c0, int cLen
  ) {
  ...
  default void recMergePartV1_R2L(
    T a, int a0, int aLen,
    T b, int b0, int bLen,
    T c, int c0, int cLen
  ) {
