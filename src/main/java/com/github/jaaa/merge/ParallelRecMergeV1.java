...
public class ParallelRecMergeV1
{
  // STATIC FIELDS
  public static class ParallelRecMergerV1 implements Merger
  {
    // STATIC FIELDS
    private static class DefaultContext<T> implements ParallelRecMergeV1Task.Context<T>,
    ...
    // CONSTRUCTORS
    public ParallelRecMergerV1( ForkJoinPool _pool ) {
    ...
    @Override public <T> void merge(
      ...
      if( nPar <= 1 || granularity <= 1024 ) ctx.mergePart(a,a0,aLen, b,b0,bLen, c,c0,cLen);
        ...
        new ParallelRecMergeV1Task<>(granularity, null, a,a0,a0+aLen, b,b0,b0+bLen, c,c0, ctx)
      );
    }
  }

  public static final Merger PARALLEL_REC_V1_MERGER = new ParallelRecMergerV1( ForkJoinPool.commonPool() );
...
// FIELDS
  ...
  // CONSTRUCTORS
  private ParallelRecMergeV1() { throw new UnsupportedOperationException("Static class cannot be instantiated."); }
