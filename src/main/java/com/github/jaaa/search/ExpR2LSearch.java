...
public class ExpR2LSearch
{
  public static final Searcher EXP_R2L_SEARCHER = new Searcher()
  {
    ...
    @Override public <T extends Comparable<? super T>> int search ( byte[] seq,                      byte key                     ) { return ExpR2LSearch.search (   0,seq.length, i -> Byte.compare(key,seq[i]) ); }
    @Override public <T extends Comparable<? super T>> int search ( byte[] seq, int from, int until, byte key                     ) { return ExpR2LSearch.search (from,until,      i -> Byte.compare(key,seq[i]) ); }
    @Override public <T>                               int search ( byte[] seq,                      byte key, ComparatorByte cmp ) { return ExpR2LSearch.search (   0,seq.length, i ->  cmp.compare(key,seq[i]) ); }
    @Override public <T>                               int search ( byte[] seq, int from, int until, byte key, ComparatorByte cmp ) { return ExpR2LSearch.search (from,until,      i ->  cmp.compare(key,seq[i]) ); }

    @Override public <T extends Comparable<? super T>> int searchR( byte[] seq,                      byte key                     ) { return ExpR2LSearch.searchR(   0,seq.length, i -> Byte.compare(key,seq[i]) ); }
    @Override public <T extends Comparable<? super T>> int searchR( byte[] seq, int from, int until, byte key                     ) { return ExpR2LSearch.searchR(from,until,      i -> Byte.compare(key,seq[i]) ); }
    @Override public <T>                               int searchR( byte[] seq,                      byte key, ComparatorByte cmp ) { return ExpR2LSearch.searchR(   0,seq.length, i ->  cmp.compare(key,seq[i]) ); }
    @Override public <T>                               int searchR( byte[] seq, int from, int until, byte key, ComparatorByte cmp ) { return ExpR2LSearch.searchR(from,until,      i ->  cmp.compare(key,seq[i]) ); }

    @Override public <T extends Comparable<? super T>> int searchL( byte[] seq,                      byte key                     ) { return ExpR2LSearch.searchL(   0,seq.length, i -> Byte.compare(key,seq[i]) ); }
    @Override public <T extends Comparable<? super T>> int searchL( byte[] seq, int from, int until, byte key                     ) { return ExpR2LSearch.searchL(from,until,      i -> Byte.compare(key,seq[i]) ); }
    @Override public <T>                               int searchL( byte[] seq,                      byte key, ComparatorByte cmp ) { return ExpR2LSearch.searchL(   0,seq.length, i ->  cmp.compare(key,seq[i]) ); }
    @Override public <T>                               int searchL( byte[] seq, int from, int until, byte key, ComparatorByte cmp ) { return ExpR2LSearch.searchL(from,until,      i ->  cmp.compare(key,seq[i]) ); }

    @Override public <T extends Comparable<? super T>> int searchGap ( byte[] seq,                      byte key                     ) { return ExpR2LSearch.searchGap (   0,seq.length, i -> Byte.compare(key,seq[i]) ); }
    @Override public <T extends Comparable<? super T>> int searchGap ( byte[] seq, int from, int until, byte key                     ) { return ExpR2LSearch.searchGap (from,until,      i -> Byte.compare(key,seq[i]) ); }
    @Override public <T>                               int searchGap ( byte[] seq,                      byte key, ComparatorByte cmp ) { return ExpR2LSearch.searchGap (   0,seq.length, i ->  cmp.compare(key,seq[i]) ); }
    @Override public <T>                               int searchGap ( byte[] seq, int from, int until, byte key, ComparatorByte cmp ) { return ExpR2LSearch.searchGap (from,until,      i ->  cmp.compare(key,seq[i]) ); }

    @Override public <T extends Comparable<? super T>> int searchGapR( byte[] seq,                      byte key                     ) { return ExpR2LSearch.searchGapR(   0,seq.length, i -> Byte.compare(key,seq[i]) ); }
    @Override public <T extends Comparable<? super T>> int searchGapR( byte[] seq, int from, int until, byte key                     ) { return ExpR2LSearch.searchGapR(from,until,      i -> Byte.compare(key,seq[i]) ); }
    @Override public <T>                               int searchGapR( byte[] seq,                      byte key, ComparatorByte cmp ) { return ExpR2LSearch.searchGapR(   0,seq.length, i ->  cmp.compare(key,seq[i]) ); }
    @Override public <T>                               int searchGapR( byte[] seq, int from, int until, byte key, ComparatorByte cmp ) { return ExpR2LSearch.searchGapR(from,until,      i ->  cmp.compare(key,seq[i]) ); }

    @Override public <T extends Comparable<? super T>> int searchGapL( byte[] seq,                      byte key                     ) { return ExpR2LSearch.searchGapL(   0,seq.length, i -> Byte.compare(key,seq[i]) ); }
    @Override public <T extends Comparable<? super T>> int searchGapL( byte[] seq, int from, int until, byte key                     ) { return ExpR2LSearch.searchGapL(from,until,      i -> Byte.compare(key,seq[i]) ); }
    @Override public <T>                               int searchGapL( byte[] seq,                      byte key, ComparatorByte cmp ) { return ExpR2LSearch.searchGapL(   0,seq.length, i ->  cmp.compare(key,seq[i]) ); }
    @Override public <T>                               int searchGapL( byte[] seq, int from, int until, byte key, ComparatorByte cmp ) { return ExpR2LSearch.searchGapL(from,until,      i ->  cmp.compare(key,seq[i]) ); }
  };
