...
public final class NetSortV1
{
  ...
  public static SorterInPlace NET_V1_SORTER = new SorterInPlace()
  {
    ...
    @Override public <T> void sort( T seq, int from, int until, CompareRandomAccessor<T> acc ) { NetSortV1.sort(seq,from,until,acc); }
    ...
    @Override public void sort(  short[] seq                                            ) { NetSortV1.sort(seq,    0,seq.length    ); }
    @Override public void sort(  short[] seq, int from, int until                       ) { NetSortV1.sort(seq, from,until          ); }
    ...
    @Override public void sort(    int[] seq                                            ) { NetSortV1.sort(seq,    0,seq.length     ); }
    @Override public void sort(    int[] seq, int from, int until                       ) { NetSortV1.sort(seq, from,until          ); }
    ...
    @Override public void sort(   long[] seq                                            ) { NetSortV1.sort(seq,    0,seq.length     ); }
    @Override public void sort(   long[] seq, int from, int until                       ) { NetSortV1.sort(seq, from,until          ); }
    ...
    @Override public void sort(   char[] seq                                            ) { NetSortV1.sort(seq,    0,seq.length     ); }
    @Override public void sort(   char[] seq, int from, int until                       ) { NetSortV1.sort(seq, from,until          ); }
    ...
    @Override public void sort(  float[] seq                                            ) { NetSortV1.sort(seq,    0,seq.length     ); }
    @Override public void sort(  float[] seq, int from, int until                       ) { NetSortV1.sort(seq, from,until          ); }
    ...
    @Override public void sort( double[] seq                                            ) { NetSortV1.sort(seq,    0,seq.length     ); }
    @Override public void sort( double[] seq, int from, int until                       ) { NetSortV1.sort(seq, from,until          ); }
    ...
    @Override public void sort( IntBuffer buf                                           ) { NetSortV1.sort(buf, buf.position(),buf.limit()     ); }
    @Override public void sort( IntBuffer buf, int from, int until                      ) { NetSortV1.sort(buf,           from,until           ); }
    @Override public void sort( IntBuffer buf,                      ComparatorInt   cmp ) { NetSortV1.sort(buf, buf.position(),buf.limit(), cmp); }
    @Override public void sort( IntBuffer buf, int from, int until, ComparatorInt   cmp ) { NetSortV1.sort(buf,          from,until,        cmp); }

    @Override public <T extends Comparable<? super T>> void sort( T[] seq                                                 )  { NetSortV1.sort(seq,    0,seq.length     ); }
    @Override public <T extends Comparable<? super T>> void sort( T[] seq, int from, int until                            )  { NetSortV1.sort(seq, from,until          ); }
