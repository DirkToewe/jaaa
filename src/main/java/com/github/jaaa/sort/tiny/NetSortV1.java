...
public final class NetSortV1
{
  ...
  public static SorterInplace NET_V1_SORTER = new SorterInplace()
  {
    ...
    @Override public void sort(   byte[] seq                                            ) { NetSortV1.sort(seq,    0,seq.length, Byte::compare); }
    @Override public void sort(   byte[] seq, int from, int until                       ) { NetSortV1.sort(seq, from,until,      Byte::compare); }
