...
public final class NetSortV3
{
// STATIC FIELDS
  public static SorterInplace NET_V3_SORTER = new SorterInplace()
  {
    ...
    @Override public void sort(   byte[] seq                                            ) { NetSortV3.sort(seq,    0,seq.length, Byte::compare); }
    @Override public void sort(   byte[] seq, int from, int until                       ) { NetSortV3.sort(seq, from,until,      Byte::compare); }
...
// FIELDS
// CONSTRUCTORS
  private NetSortV3() { throw new UnsupportedOperationException("Static class cannot be instantiated."); }
// METHODS
}
