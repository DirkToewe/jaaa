...
public final class QuickSortV3
{
  // STATIC FIELDS
  public static SorterInPlace QUICK_V3_SORTER = new SorterInPlace()
  {
    ...
    @Override public <T> void sort( T seq, int from, int until, CompareRandomAccessor<T> acc ) { QuickSortV3.sort(seq,from,until,acc); }
    @Override public     void sort(        int from, int until, CompareSwapAccess        acc ) { QuickSortV3.sort(    from,until,acc); }

    @Override public void sort(   byte[] seq                                          ) { QuickSortV3.sort(seq,    0,seq.length     ); }
    @Override public void sort(   byte[] seq, int from, int until                     ) { QuickSortV3.sort(seq, from,until          ); }
    @Override public void sort(   byte[] seq,                      ComparatorByte cmp ) { QuickSortV3.sort(seq,    0,seq.length, cmp); }
    @Override public void sort(   byte[] seq, int from, int until, ComparatorByte cmp ) { QuickSortV3.sort(seq, from,until,      cmp); }

    @Override public void sort(  short[] seq                                           ) { QuickSortV3.sort(seq,    0,seq.length     ); }
    @Override public void sort(  short[] seq, int from, int until                      ) { QuickSortV3.sort(seq, from,until          ); }
    @Override public void sort(  short[] seq,                      ComparatorShort cmp ) { QuickSortV3.sort(seq,    0,seq.length, cmp); }
    @Override public void sort(  short[] seq, int from, int until, ComparatorShort cmp ) { QuickSortV3.sort(seq, from,until,      cmp); }

    @Override public void sort(    int[] seq                                         ) { QuickSortV3.sort(seq,    0,seq.length     ); }
    @Override public void sort(    int[] seq, int from, int until                    ) { QuickSortV3.sort(seq, from,until          ); }
    @Override public void sort(    int[] seq,                      ComparatorInt cmp ) { QuickSortV3.sort(seq,    0,seq.length, cmp); }
    @Override public void sort(    int[] seq, int from, int until, ComparatorInt cmp ) { QuickSortV3.sort(seq, from,until,      cmp); }

    @Override public void sort(   long[] seq                                          ) { QuickSortV3.sort(seq,    0,seq.length     ); }
    @Override public void sort(   long[] seq, int from, int until                     ) { QuickSortV3.sort(seq, from,until          ); }
    @Override public void sort(   long[] seq,                      ComparatorLong cmp ) { QuickSortV3.sort(seq,    0,seq.length, cmp); }
    @Override public void sort(   long[] seq, int from, int until, ComparatorLong cmp ) { QuickSortV3.sort(seq, from,until,      cmp); }

    @Override public void sort(   char[] seq                                          ) { QuickSortV3.sort(seq,    0,seq.length     ); }
    @Override public void sort(   char[] seq, int from, int until                     ) { QuickSortV3.sort(seq, from,until          ); }
    @Override public void sort(   char[] seq,                      ComparatorChar cmp ) { QuickSortV3.sort(seq,    0,seq.length, cmp); }
    @Override public void sort(   char[] seq, int from, int until, ComparatorChar cmp ) { QuickSortV3.sort(seq, from,until,      cmp); }

    @Override public void sort(  float[] seq                                           ) { QuickSortV3.sort(seq,    0,seq.length     ); }
    @Override public void sort(  float[] seq, int from, int until                      ) { QuickSortV3.sort(seq, from,until          ); }
    @Override public void sort(  float[] seq,                      ComparatorFloat cmp ) { QuickSortV3.sort(seq,    0,seq.length, cmp); }
    @Override public void sort(  float[] seq, int from, int until, ComparatorFloat cmp ) { QuickSortV3.sort(seq, from,until,      cmp); }

    @Override public void sort( double[] seq                                            ) { QuickSortV3.sort(seq,    0,seq.length     ); }
    @Override public void sort( double[] seq, int from, int until                       ) { QuickSortV3.sort(seq, from,until          ); }
    @Override public void sort( double[] seq,                      ComparatorDouble cmp ) { QuickSortV3.sort(seq,    0,seq.length, cmp); }
    @Override public void sort( double[] seq, int from, int until, ComparatorDouble cmp ) { QuickSortV3.sort(seq, from,until,      cmp); }

    @Override public void sort( IntBuffer buf                                          ) { QuickSortV3.sort(buf, buf.position(),buf.limit()     ); }
    @Override public void sort( IntBuffer buf , int from, int until                    ) { QuickSortV3.sort(buf,           from,until           ); }
    @Override public void sort( IntBuffer buf ,                      ComparatorInt cmp ) { QuickSortV3.sort(buf, buf.position(),buf.limit(), cmp); }
    @Override public void sort( IntBuffer buf , int from, int until, ComparatorInt cmp ) { QuickSortV3.sort(buf,           from,until,       cmp); }

    @Override public <T extends Comparable<? super T>> void sort( T[] seq                                                 )  { QuickSortV3.sort(seq,    0,seq.length     ); }
    @Override public <T extends Comparable<? super T>> void sort( T[] seq, int from, int until                            )  { QuickSortV3.sort(seq, from,until          ); }
    @Override public <T>                               void sort( T[] seq,                      Comparator<? super T> cmp )  { QuickSortV3.sort(seq,    0,seq.length, cmp); }
    @Override public <T>                               void sort( T[] seq, int from, int until, Comparator<? super T> cmp )  { QuickSortV3.sort(seq, from,until,      cmp); }
  };
...
// STATIC CONSTRUCTOR
  ...
  public static <T> void sort( T[] seq, int from, int until, Comparator<? super T> cmp )
  {
    new QuickSortV3Access() {
      @Override public int compare( int i, int j ) { return cmp.compare( seq[i], seq[j] ); }
      @Override public void   swap( int i, int j ) { Swap.swap(seq,i,j); }
      @Override public void quickSortV3_sortRun( int from, int until ) {
  ...
  // FIELDS
// CONSTRUCTORS
  private QuickSortV3() { throw new UnsupportedOperationException("Static class cannot be instantiated."); }
// METHODS
}
