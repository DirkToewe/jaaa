...
{
  private static record Acc( CompareSwapAccess acc ) implements SelectAccess, QuickSelectV1Access
  {
    @Override public void select( int from, int mid, int until ) { quickSelectV1(from,mid,until); }
