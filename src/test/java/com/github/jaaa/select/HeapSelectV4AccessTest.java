...
@Group
public class HeapSelectV4AccessTest
{
  private static record Acc( CompareSwapAccess acc ) implements SelectAccess, HeapSelectV3V4Access
  {
    @Override public void select( int from, int mid, int until ) { heapSelectV4(from,mid,until); }
