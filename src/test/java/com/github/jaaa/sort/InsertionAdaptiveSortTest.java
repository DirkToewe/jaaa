...
public class InsertionAdaptiveSortTest
{
  ...
  {
    SortTest() {
      super(new StaticMethodsSorterInplace(InsertionAdaptiveSort.class) {
  ...
  {
    SorterInplaceTest() { super(INSERTION_ADAPTIVE_SORTER); }
  }
  ...
  private static abstract class TestTemplate implements SorterInplaceTestTemplate
  {
    ...
    void sortsAdaptivelyAccessWithRangeByte( @ForAll WithRange<@Size(min=0, max=MAX_SIZE) byte[]> sample )
    {
      ...
      InsertionAdaptiveSort.sort(from,until, acc);
