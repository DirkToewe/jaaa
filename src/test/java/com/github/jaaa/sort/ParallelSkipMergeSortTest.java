...
import static com.github.jaaa.sort.ParallelSkipMergeSort.PARALLEL_SKIP_MERGE_SORTER;


@Group
public class ParallelSkipMergeSortTest
{
  private final Sorter sorter = new StaticMethodsSorter(ParallelSkipMergeSort.class) {
    @Override public boolean isStable    () { return PARALLEL_SKIP_MERGE_SORTER.isStable    (); }
    @Override public boolean isThreadSafe() { return PARALLEL_SKIP_MERGE_SORTER.isThreadSafe(); }
  };
  ...
  @Group class SorterTestSmall implements SorterTestTemplate {
    @Override public int maxArraySize() { return 100; }
    @Override public Sorter sorter() { return PARALLEL_SKIP_MERGE_SORTER; }
  }
