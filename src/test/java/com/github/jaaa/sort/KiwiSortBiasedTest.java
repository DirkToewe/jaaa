...
import static com.github.jaaa.sort.KiwiSortBiased.KIWI_BIASED_SORTER;


@Group
public class KiwiSortBiasedTest
{
  private final SorterInPlace sorter = new StaticMethodsSorterInPlace(KiwiSortBiased.class) {
    @Override public boolean isStable    () { return KIWI_BIASED_SORTER.isStable    (); }
    @Override public boolean isThreadSafe() { return KIWI_BIASED_SORTER.isThreadSafe(); }
  };
  ...
  @Group class SorterTestSmall implements SorterInPlaceTestTemplate {
    @Override public int maxArraySize() { return 100; }
    @Override public SorterInPlace sorter() { return KIWI_BIASED_SORTER; }
  }
