...
{
  private final SorterInPlace sorter = new StaticMethodsSorterInPlace(HeapSort.class) {
    @Override public boolean isStable    () { return HEAP_SORTER.isStable    (); }
    @Override public boolean isThreadSafe() { return HEAP_SORTER.isThreadSafe(); }
  };
