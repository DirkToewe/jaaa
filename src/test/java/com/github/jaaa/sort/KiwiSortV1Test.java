...
import static com.github.jaaa.sort.KiwiSortV1.KIWI_V1_SORTER;


@Group
public class KiwiSortV1Test
{
  private final SorterInPlace sorter = new StaticMethodsSorterInPlace(KiwiSortV1.class) {
    @Override public boolean isStable    () { return KIWI_V1_SORTER.isStable    (); }
    @Override public boolean isThreadSafe() { return KIWI_V1_SORTER.isThreadSafe(); }
  };
  ...
  @Group class SorterTestSmall implements SorterInPlaceTestTemplate {
    @Override public int maxArraySize() { return 100; }
    @Override public SorterInPlace sorter() { return KIWI_V1_SORTER; }
  }
