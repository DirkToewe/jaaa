...
public interface SorterInplaceTestLargeTemplate extends SorterTestLargeTemplate, SorterInplaceTestTemplate
{
// STATIC FIELDS
...
// METHODS
  ...
  @Property( tries = N_TRIES )
  default void sortsStablyAccessWithOffsetBooleanLarge(
  ...
  @Property( tries = N_TRIES )
  default void sortsStablyAccessWithOffsetByteLarge(
  ...
  @Property( tries = N_TRIES )
  default void sortsStablyAccessWithOffsetIntLarge(
