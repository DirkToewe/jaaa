...
public class HwangLinMergeV2AccessorTest extends MergeAccessorTestTemplate
{
  ...
  private static final class HLAccessor<T> implements HwangLinMergeV2Accessor<T>, MergeAccessor<T>
  {
  ...
  class L2R extends MergeAccessorTestTemplate
  {
    ...
    private final class HLAccessor<T> implements HwangLinMergeV2Accessor<T>, MergeAccessor<T>
    {
      private final CompareRandomAccessor<T> acc;
