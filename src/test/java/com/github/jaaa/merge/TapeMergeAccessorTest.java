...
public class TapeMergeAccessorTest extends MergeAccessorTestTemplate
{
  ...
  private static final class HLAccessor<T> implements TapeMergeAccessor<T>, MergeAccessor<T>
  {
  ...
  class L2R extends MergeAccessorTestTemplate
  {
    ...
    private final class HLAccessor<T> implements TapeMergeAccessor<T>, MergeAccessor<T>
    {
      private final CompareRandomAccessor<T> acc;
