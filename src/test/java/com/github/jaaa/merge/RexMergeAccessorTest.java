...
public class RexMergeAccessorTest extends MergeAccessorTestTemplate
{
                                                   ...
                                                   RexMergeAccessor<T>
  {
    ...
    @Override public void  merge( T a, int i, int m, T b, int j, int n, T c, int k ) { rexMerge(a,i,m, b,j,n, c,k); }
  }
  ...
  class L2R extends MergeAccessorTestTemplate
  {
                                              ...
                                              RexMergeAccessor<T>
    {
      ...
      @Override public void   copy( T a, int i, T b, int j ) { acc.copy(a,i, b,j); }
      @Override public void   swap( T a, int i, T b, int j ) { acc.swap(a,i, b,j); }
      @Override public void  merge( T a, int i, int m, T b, int j, int n, T c, int k ) { rexMergeL2R(a,i,m, b,j,n, c,k); }
    }
  ...
  class R2L extends MergeAccessorTestTemplate
  {
                                              ...
                                              RexMergeAccessor<T>
    {
      ...
      @Override public void   copy( T a, int i, T b, int j ) { acc.copy(a,i, b,j); }
      @Override public void   swap( T a, int i, T b, int j ) { acc.swap(a,i, b,j); }
      @Override public void  merge( T a, int i, int m, T b, int j, int n, T c, int k ) { rexMergeR2L(a,i,m, b,j,n, c,k); }
    }
