...
public class TimMergeAccessorTest extends MergeAccessorTestTemplate
{
  ...
  private static final class HLAccessor<T> implements TimMergeAccessor<T>, MergeAccessor<T>
  {
  ...
  class L2R extends MergeAccessorTestTemplate
  {
    ...
    private final class HLAccessor<T> implements TimMergeAccessor<T>, MergeAccessor<T>
    {
      private final CompareRandomAccessor<T> acc;
      ...
      @Override public void merge( T a, int i, int m, T b, int j, int n, T c, int k ) { timMergeL2R(a,i,m, b,j,n, c,k); }
    }
  ...
  class R2L extends MergeAccessorTestTemplate
  {
    ...
    private final class HLAccessor<T> implements TimMergeAccessor<T>, MergeAccessor<T>
    {
      ...
      @Override public void merge( T a, int i, int m, T b, int j, int n, T c, int k ) { timMergeR2L(a,i,m, b,j,n, c,k); }
    }
