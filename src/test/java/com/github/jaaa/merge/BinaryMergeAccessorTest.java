...
public class BinaryMergeAccessorTest extends MergeAccessorTestTemplate
{
  ...
  private static final class HLAccessor<T> implements BinaryMergeAccessor<T>, MergeAccessor<T>
  {
  ...
  class L2R extends MergeAccessorTestTemplate
  {
    ...
    private final class HLAccessor<T> implements BinaryMergeAccessor<T>, MergeAccessor<T>
    {
      private final CompareRandomAccessor<T> acc;
