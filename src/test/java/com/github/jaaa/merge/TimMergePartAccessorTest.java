...
public class TimMergePartAccessorTest extends MergePartAccessorTestTemplate
{
  ...
  {
    @Override public int maxArraySize      () { return TimMergePartAccessorTest.this.maxArraySize(); }
    @Override public int maxArraySizeString() { return TimMergePartAccessorTest.this.maxArraySizeString(); }
    @Override protected boolean    isStable() { return TimMergePartAccessorTest.this.isStable(); }
    ...
    @Override protected <T> MergeAccessor<T> createAccessor( CompareRandomAccessor<T> srtAcc ) {
      var acc = TimMergePartAccessorTest.this.createAccessor(srtAcc);
