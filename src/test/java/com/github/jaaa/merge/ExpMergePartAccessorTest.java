...
public class ExpMergePartAccessorTest extends MergePartAccessorTestTemplate
{
  ...
  {
    @Override public int maxArraySize      () { return ExpMergePartAccessorTest.this.maxArraySize(); }
    @Override public int maxArraySizeString() { return ExpMergePartAccessorTest.this.maxArraySizeString(); }
    @Override protected boolean    isStable() { return ExpMergePartAccessorTest.this.isStable(); }
  ...
  @Override protected <T> MergePartAccessor<T> createAccessor( CompareRandomAccessor<T> randAcc ) {
    return new ExpMergePartAccessorTest.BMPAccessor<>(randAcc);
  }
}
