...
public class TapeMergePartAccessorTest extends MergePartAccessorTestTemplate
{
  ...
  @Group
  public class MergeFullyL2R extends MergeAccessorTestTemplate
  {
    @Override public int maxArraySize      () { return TapeMergePartAccessorTest.this.maxArraySize(); }
    @Override public int maxArraySizeString() { return TapeMergePartAccessorTest.this.maxArraySizeString(); }
    @Override protected boolean    isStable() { return TapeMergePartAccessorTest.this.isStable(); }
    ...
    @Override protected <T> MergeAccessor<T> createAccessor( CompareRandomAccessor<T> srtAcc ) {
      var acc = TapeMergePartAccessorTest.this.createAccessor(srtAcc);
