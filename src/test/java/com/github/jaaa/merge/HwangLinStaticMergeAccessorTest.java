...
public class HwangLinStaticMergeAccessorTest extends MergeAccessorTestTemplate
{
  ...
  private static final class HLAccessor<T> implements HwangLinStaticMergeAccessor<T>, MergeAccessor<T>
  {
  ...
  class L2R extends MergeAccessorTestTemplate
  {
    ...
    private final class HLAccessor<T> implements HwangLinStaticMergeAccessor<T>, MergeAccessor<T>
    {
      private final CompareRandomAccessor<T> acc;
