...
public class HwangLinMergeV1AccessorTest extends MergeAccessorTestTemplate
{
  ...
  private static final class HLAccessor<T> implements HwangLinMergeV1Accessor<T>, MergeAccessor<T>
  {
  ...
  class L2R extends MergeAccessorTestTemplate
  {
    ...
    private final class HLAccessor<T> implements HwangLinMergeV1Accessor<T>, MergeAccessor<T>
    {
      private final CompareRandomAccessor<T> acc;
