...
public class ExpMergePartV1AccessorTest extends MergePartAccessorTestTemplate
{
  ...
  {
    @Override public int maxArraySize      () { return ExpMergePartV1AccessorTest.this.maxArraySize(); }
    @Override public int maxArraySizeString() { return ExpMergePartV1AccessorTest.this.maxArraySizeString(); }
    @Override protected boolean    isStable() { return ExpMergePartV1AccessorTest.this.isStable(); }
    ...
    @Override protected <T> MergeAccessor<T> createAccessor( CompareRandomAccessor<T> srtAcc ) {
      var acc = ExpMergePartV1AccessorTest.this.createAccessor(srtAcc);
  ...
  @Override protected <T> MergePartAccessor<T> createAccessor( CompareRandomAccessor<T> randAcc ) {
    return new ExpMergePartV1AccessorTest.BMPAccessor<>(randAcc);
  }
}
