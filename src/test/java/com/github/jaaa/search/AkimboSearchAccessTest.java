...
public class AkimboSearchAccessTest implements SearchAccessTestTemplate
{
  ...
  @Override public long comparisonLimit( int from, int until, int i ) { return from==until ? 0 : 2 + 2*log2Floor( 1 + min(until-i,i-from) ); }
}
